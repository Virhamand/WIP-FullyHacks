  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start px-4 py-8">
      <div className="w-full max-w-2xl space-y-5">
        ...
        {/* AI commentary — shown after all answers are in */}
        {aiCommentary && (
          <div className="border border-yellow-400/40 bg-yellow-400/10 rounded-xl p-4">
            <p className="text-xs font-semibold uppercase tracking-wide text-yellow-500 mb-1">💬 A player commented…</p>
            <p className="text-sm italic text-foreground">{aiCommentary}</p>
          </div>
        )}
...
export default function Game() {
  ...
  const { room, participants, currentRound, answers, pointings, votes, allRoundsPointings, myAnswered, myPointed, myVoted, playerCount, maxPlayers } = state;
